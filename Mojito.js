...
function hideAccounts() {
    ...
    accounts = accounts.concat(
      Array.prototype.slice.call(
        document.querySelectorAll(
          "li#moduleAccounts-credit li.accounts-data-li"
        )
      )
    );
  }
  if (OPTIONS.hideZeroBankBalance) {
    accounts = accounts.concat(
      Array.prototype.slice.call(
        document.querySelectorAll("li#moduleAccounts-bank li.accounts-data-li")
      )
    );
  }
  if (OPTIONS.hideZeroInvestBalance) {
    accounts = accounts.concat(
      Array.prototype.slice.call(
        document.querySelectorAll(
          "li#moduleAccounts-investment li.accounts-data-li"
        )
      )
    );
  }
  if (OPTIONS.hideZeroLoanBalance) {
    accounts = accounts.concat(
      Array.prototype.slice.call(
        document.querySelectorAll("li#moduleAccounts-loan li.accounts-data-li")
      )
    );
  }
...
function fixStyles() {
  ...
  if (!OPTIONS.colorBalances) {
    ...
    styleSheet.insertRule(
      "#module-accounts h3 > .balance  {color:black}",
      styleSheet.cssRules.length
    );
    styleSheet.insertRule(
      "#module-accounts h3 > .negativeBalance {color:black}",
      styleSheet.cssRules.length
    );
  }
  ...
  if (OPTIONS.oldFonts) {
    ...
    styleSheet.insertRule(
      "#module-budget a {color: #3b73af !important }",
      styleSheet.cssRules.length
    );
  }
}
...
// a =
//   "%7B%22query%22%3A%22%22%2C%22offset%22%3A0%2C%22typeFilter%22%3A%22cash%22%2C%22typeSort%22%3A8%2C%22startDate%22%3A%2206%2F01%2F2017%22%2C%22endDate%22%3A%2206%2F30%2F2017%22%7D";
// //a = '%7B%22accountId%22%3A0%2C%22query%22%3A%22tag%3A%5C%22Joint%5C%22%22%2C%22offset%22%3A0%7D'
// un = unescape(a);
// hash = JSON.parse(un);
//
// a = "%7B%22accountId%22%3A5632483%2C%22offset%22%3A0%2C%22typeSort%22%3A8%7D";
// a =
//   "%7B%22query%22%3A%22category%3D%3A%20Groceries%22%2C%22offset%22%3A0%2C%22typeFilter%22%3A%22cash%22%2C%22typeSort%22%3A8%7D";
// a =
